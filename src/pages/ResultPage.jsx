...
const ResultPage = ({ score, questions, rootHref }) => {
    ...
    const message = score < halfQuestionsLength
        ? "Es scheint, dass du noch etwas üben musst!"
        : "Toll gemacht! Du hast eine gute Leistung gezeigt!";

    return (
        <div className="flex w-full flex-col items-center justify-center space-y-8 p-10 bg-gradient-to-b from-blue-200 to-blue-500 min-h-screen">
            <div className="result-text text-3xl text-center font-bold text-white">
                <span>Ergebnis: </span>
